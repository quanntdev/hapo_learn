                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('course.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"  class="form-control @error('course_name') is-invalid @enderror" aria-describedby="emailHelp" onkeyup="ChangeToSlug();" id="slug" placeholder="Add a Course's name . . ." name="course_name" value="{{old('course_name')}}" >
                          @error('course_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug_course') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Add  Slug . . . " name="slug_course" value="{{old('slug_course')}}" id="convert_slug">
                            @error('slug_course')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="description" @error('description') is-invalid @enderror></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('price') is-invalid @enderror" aria-describedby="emailHelp" name="price" value="{{old('price')}}">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
