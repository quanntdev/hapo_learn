                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input  id="text" type="text" class="form-control login-input @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}"  autocomplete="username" required autofocus>
                            @error('username')
                          ...
                          <div class="mb-3">
                            ...
                            <input  id="password" type="password" class="form-control login-input @error('password') is-invalid @enderror" name="password"  autocomplete="current-password" minlength="8" required>
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
